...
import {
  ClipboardCheck, AlertTriangle, ListChecks, PlusCircle, Plus, ArrowRight,
    ...
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <Link
            href="/inspector/inspections?schedule=true"
            id="schedule-inspection-action-btn"
            style={{
              display: "flex",
              alignItems: "center",
              gap: 6,
          ...
          >
            <Calendar size={15} color="#86efac" /> Schedule Inspection
          </Link>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 20 }}>
        {[
          { label: "Today's Inspections", value: "4 / 6", sub: "+16.5% vs yesterday", pos: true, color: "#2d6a4f", spark: sparklines.inspections, icon: <ClipboardCheck size={18} color="white" />, iconBg: "#2d6a4f" },
          { label: "Open Violations",      value: "5",     sub: "2 High Priority",       pos: false, color: "#dc2626", spark: sparklines.violations,  icon: <AlertTriangle size={18} color="white" />,  iconBg: "#dc2626" },
          { label: "Pending Actions",      value: "7",     sub: "3 Overdue tasks",       pos: false, color: "#ea580c", spark: sparklines.actions,     icon: <ListChecks size={18} color="white" />,     iconBg: "#ea580c" },
          { label: "Section Safety Score", value: "93%",   sub: "+4.2% this week",       pos: true, color: "#16a34a", spark: sparklines.score,       icon: <ShieldCheck size={18} color="white" />,    iconBg: "#16a34a" },
        ].map(kpi => (
          <div
            key={kpi.label}
            style={{
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
              <div style={{
                ...
                background: `linear-gradient(135deg, ${kpi.iconBg} 0%, ${kpi.iconBg}cc 100%)`,
                display: "flex", alignItems: "center", justifyContent: "center",
                boxShadow: `0 4px 14px ${kpi.iconBg}50`,
              }}>
                {kpi.icon}
              </div>
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: 8, marginTop: 2 }}>
                <span style={{ fontSize: 26, fontWeight: 900, color: "var(--text-primary)", letterSpacing: "-0.02em" }}>{kpi.value}</span>
                <span style={{ fontSize: 11, fontWeight: 700, color: kpi.pos ? "#16a34a" : "#dc2626", display: "flex", alignItems: "center", gap: 2 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: 16 }}>
        ...
        <div style={{ background: "white", border: "1px solid var(--border)", borderRadius: 14, padding: 20 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
            <div>
              <h3 style={{ fontSize: 14, fontWeight: 800, color: "var(--text-primary)", margin: 0 }}>Today's Inspection Schedule</h3>
              <p style={{ fontSize: 12, color: "var(--text-muted)", margin: "2px 0 0" }}>Click status to toggle completion in the field</p>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <Link href="/inspector/inspections" style={{ fontSize: 12, color: "var(--text-muted)", fontWeight: 600, textDecoration: "none", display: "flex", alignItems: "center", gap: 3 }}>
