    ...
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif", paddingBottom: 40 }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "#6b7280", marginBottom: 6 }}>
          ...
          <span>/</span>
          <span style={{ color: "#2563eb", fontWeight: 600 }}>Statutory Cadre & Manager Allocation</span>
        </div>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <h1 style={{ fontSize: 22, fontWeight: 800, color: "#111827", margin: 0 }}>
                CMR 2017 Reg. 27 Statutory Manager Allocation Console
              </h1>
            </div>
            <p style={{ fontSize: 13, color: "#6b7280", margin: "4px 0 0 48px" }}>
              Pan-India oversight for Coal India Limited. Evaluates Manager competency, enforces single-mine statutory mandates, and generates DGMS Form IV appointment notices.
            </p>
          </div>
        ...
        {[
          ...
          return (
            <div key={i} style={{ background: "white", border: "1px solid #e5e7eb", borderRadius: 12, padding: "16px 18px" }}>
              ...
              <div style={{ fontSize: 11.5, color: "#6b7280", marginTop: 2 }}>{kpi.sub}</div>
            </div>
          );
        })}
      </div>
      ...
      <div style={{
        ...
        <div>
          <h4 style={{ fontSize: 13, fontWeight: 700, color: "#1e40af", margin: 0 }}>
            DGMS Statutory Assignment Protocol (Coal Mines Regulations 2017)
          </h4>
          <p style={{ fontSize: 12, color: "#374151", margin: "4px 0 0 0", lineHeight: 1.5 }}>
            • <strong>Regulation 27(1)</strong>: No individual can act as Manager of more than one mine simultaneously without explicit prior written authorization of the Chief Inspector.<br />
            • <strong>Opencast Mines handling &gt; 20,000 m³/month</strong> or <strong>Underground Mines producing &gt; 2,500 MT/month</strong> mandate a certified <strong>First Class Manager (Coal)</strong>.
          </p>
        </div>
      </div>
      ...
      <div style={{ background: "white", border: "1px solid #e5e7eb", borderRadius: 14, overflow: "hidden", boxShadow: "0 1px 3px rgba(0,0,0,0.05)", marginBottom: 30 }}>
        <div style={{ padding: "16px 20px", borderBottom: "1px solid #e5e7eb", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <h3 style={{ fontSize: 15, fontWeight: 700, color: "#111827", margin: 0 }}>National Colliery Manager Cadre Roster</h3>
            <p style={{ fontSize: 12, color: "#6b7280", margin: "2px 0 0 0" }}>Real-time appointment and vacancy status for all monitored CIL pits</p>
          </div>
          <span style={{ fontSize: 12, color: "#6b7280" }}>
            Showing <strong>{filteredCollieries.length}</strong> collieries
          </span>
        </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", fontSize: 12.5 }}>
            <thead>
              <tr style={{ background: "#f9fafb", borderBottom: "1px solid #e5e7eb", color: "#4b5563" }}>
                <th style={{ padding: "12px 16px", fontWeight: 700 }}>Colliery / Pit</th>
                <th style={{ padding: "12px 16px", fontWeight: 700 }}>Type & Capacity</th>
                <th style={{ padding: "12px 16px", fontWeight: 700 }}>Mandated Qualification</th>
                <th style={{ padding: "12px 16px", fontWeight: 700 }}>Statutory Manager (CMR 27)</th>
                <th style={{ padding: "12px 16px", fontWeight: 700 }}>Cadre Status</th>
              ...
              {filteredCollieries.map(col => {
                ...
                return (
                  <tr key={col.key} style={{ borderBottom: "1px solid #f3f4f6" }}>
                    ...
                    {/* Mandated Cert */}
                    <td style={{ padding: "14px 16px" }}>
                      <div style={{ fontWeight: 600, color: "#374151" }}>{col.requiredQualification}</div>
                      <div style={{ fontSize: 10.5, color: "#6b7280", marginTop: 2 }}>
                        {isOpencast ? "Handling > 20k m³/mo" : "Output > 2,500 MT/mo"}
                      </div>
                    </td>
                    ...
                    <td style={{ padding: "14px 16px" }}>
                      <span style={{
                        ...
                        {mgr ? "Statutory Charge Active" : "Vacant Cadre"}
                      </span>
                    </td>
                    ...
                    <td style={{ padding: "14px 16px", textAlign: "right" }}>
                      <div style={{ display: "flex", justifyContent: "flex-end", gap: 8 }}>
                        ...
                        >
                          <Award size={12} />
                          {mgr ? "Reassign / Transfer" : "Appoint Manager"}
                        </button>
                      </div>
                    </td>
                  </tr>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
          <div>
            <h3 style={{ fontSize: 15, fontWeight: 700, color: "#111827", margin: 0 }}>
              Certified Mining Officers Directory (DGMS Certified Pool)
            </h3>
