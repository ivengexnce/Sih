  ...
  return (
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif" }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <h2 style={{ fontSize: 18, fontWeight: 700, color: "#111827" }}>Hazard & Violation Reports</h2>
        <p style={{ fontSize: 13, color: "#6b7280", marginTop: 2 }}>Log field safety violations, categorize risk levels, and dispatch corrective mandates.</p>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14, marginBottom: 20 }}>
        {[
          ...
          <div
            ...
            style={{
              background: "white",
              border: `1.5px solid ${statusFilter === kpi.filter ? kpi.color : "#e5e7eb"}`,
              borderRadius: 12,
              padding: "16px 18px",
              cursor: "pointer",
          ...
          >
            <p style={{ fontSize: 10.5, color: "#6b7280", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.04em" }}>{kpi.label}</p>
            <p style={{ fontSize: 26, fontWeight: 700, color: kpi.color, marginTop: 4 }}>{kpi.value}</p>
          </div>
        ))}
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.55fr", gap: 18 }}>
        ...
        {/* Log Form Container */}
        <div style={{ background: "white", border: "1px solid #e5e7eb", borderRadius: 12, overflow: "hidden", alignSelf: "start" }}>
          <div style={{ padding: "16px 20px", borderBottom: "1px solid #fee2e2", background: "#fef2f2", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <h3 style={{ fontSize: 14, fontWeight: 700, color: "#dc2626" }}>Log Hazard / Violation</h3>
            </div>
            <span style={{ fontSize: 11, background: "white", color: "#dc2626", padding: "2px 8px", borderRadius: 12, fontWeight: 700 }}>
              Live Dispatch
            </span>
          </div>
